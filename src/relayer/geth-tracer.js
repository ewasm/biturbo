// Taken from:
// https://github.com/ethereum/go-ethereum/blob/0218d7001d2a566b35072ee21b9f84f6b2711bbe/eth/tracers/internal/tracers/prestate_tracer.js
//
	...
	step: function(log, db) {
		...
		switch (log.op.toString()) {
			...
			case 'SSTORE':case 'SLOAD':
				...
				break;
      case 'BLOCKHASH':
        if (!this.prestate.blockhashReqs) {
          this.prestate.blockhashReqs = {}
        }
        this.prestate.blockhashReqs['0x' + log.stack.peek(0).valueOf().toString(16)] = true
        break;
		}
	},
